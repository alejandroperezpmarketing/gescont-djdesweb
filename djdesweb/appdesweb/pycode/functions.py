...
class Rivers():
    ...
    create table d.rivers (
    gid  serial PRIMARY KEY,
    description varchar DEFAULT 'calle',
    river_name varchar, 
    zone integer,
    ...
    river_lenght double precision,
    river_validation boolean,
    geom geometry (LINESTRING,25830));

    create table d.rivers (gid  serial PRIMARY KEY,description varchar DEFAULT 'calle',river_name varchar,zone integer,municipality varchar,provice varchar DEFAULT 'valencia',region varchar DEFAULT 'valencia',country varchar DEFAULT 'spain',ONEWAY oneway_domain,river_lenght double precision,river_validation boolean,geom geometry (LINESTRING,25830));
...
class Especies():
    """
    ################
    create table d.especies (
    gid  serial PRIMARY KEY, 
    species_type varchar,
    care varchar,
    motivation varchar, #how to gift or why to by this species
    name varchar, 
    scientific_name varchar, 
    species_lives_season varchar,
    geom geometry (POINT,25830));
    
    create table d.especies (gid  serial PRIMARY KEY, description varchar, species_type varchar, care varchar, motivation varchar, name varchar, scientific_name varchar, species_lives_season varchar, geom geometry (POINT,25830));

    #colocar en el mapa las  especies que veo en ñi ruta de montaña  region o documentar la flora de la zona.
    """
